...
namespace ssoserver.Controllers
{
	public class HomeController :Controller
	{
		...
		public async Task<ActionResult> Logout()
		{
			...
			{
				await http.GetAsync("http://localhost:30744/Home/ClearToken?tokenId=" + TokenIds[Session.SessionID]);
				await http.GetAsync("http://localhost:30929/Home/ClearToken?tokenId=" + TokenIds[Session.SessionID]);
			}
