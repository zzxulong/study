...
namespace QQLogin.Models
{
    public class QQLoginHelper
    {
        public static string appId = "101834012"; //申请QQ登录成功后，分配给应用的appid。
        public static string appKey = "ae3dbe4765967c3fb46f891ab406e3ab"; //申请QQ登录成功后，分配给应用的appkey。
        public static string redirect_uri = "http://www.zcjlw.com/user/account/qqloginreturn"; //成功授权后的回调地址，必须是注册appid时填写的主域名下的地址。
