...
namespace QQLogin.Models
{
    ...
    {
        public static string appId = "改成你自己的呀"; //申请QQ登录成功后，分配给应用的appid。
        public static string appKey = "改成你自己的呀"; //申请QQ登录成功后，分配给应用的appkey。
        public static string redirect_uri = "改成你自己的呀"; //成功授权后的回调地址，必须是注册appid时填写的主域名下的地址。
